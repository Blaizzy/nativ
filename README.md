...
| **Menu bar controls** | Start or stop the server, change the loaded model, check serving statistics, or pin live CPU, GPU, and RAM usage as a percentage or mini graph. |
