...
| **Menu bar controls** | Start or stop the server, change the loaded model, check serving statistics, or pin multiple live CPU, GPU, and RAM percentages and mini graphs. |
