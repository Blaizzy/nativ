...
public struct NativWorkflowTrigger: Codable, Hashable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        try rejectUnknownWorkflowFields(decoder, allowed: ["id", "type", "shortcut", "commandID"])
...
public struct NativWorkflowStep: Codable, Hashable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        try rejectUnknownWorkflowFields(decoder, allowed: ["id", "type", "task", "model", "inputs", "maxTokens", "temperature"])
        let container = try decoder.container(keyedBy: CodingKeys.self)
        id = try container.decode(String.self, forKey: .id)
...
public struct NativExtensionWorkflow: Codable, Hashable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        try rejectUnknownWorkflowFields(decoder, allowed: ["schemaVersion", "triggers", "steps"])
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
private func rejectUnknownWorkflowFields(_ decoder: any Decoder, allowed: Set<String>) throws {
    ...
    if let unknown = container.allKeys.sorted(by: { $0.stringValue < $1.stringValue })
        ...
        throw DecodingError.dataCorrupted(.init(
            ...
            debugDescription: "Unknown workflow field “\(unknown.stringValue)”."
        ))
    }
}
