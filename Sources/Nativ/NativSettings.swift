...
struct NativSettings: Codable, Equatable {
    ...
    init(from decoder: Decoder) throws {
        ...
        userKits = try container.decodeIfPresent([UserNativKit].self, forKey: .userKits) ?? defaults.userKits
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(userKits, forKey: .userKits)
